...
# from  import diabetic_retinopathy,brain_tumor_segmentation,chestXray,image_processing, covid_prediction,region_of_interset,breast_cancer,skin_cancer
from fastapi.middleware.cors import CORSMiddleware
import preprocessing,plots,dim_reduc,classification,clustering,feature_selection
